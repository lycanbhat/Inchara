...
export function Navbar({
  ...
  return (
    <>
      <header className="flex-shrink-0 flex items-center justify-between px-4 sm:px-6 h-16 bg-white border-b border-gray-100">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2">
          ...
          <button
            ...
            className="hidden sm:flex items-center gap-1.5 text-xs bg-gray-900 text-white px-2 py-1.5 sm:px-3 sm:py-1.5 rounded-md hover:bg-gray-800 transition-colors"
            title="Add Expense"
          >
      ...
      <button
        onClick={onAddExpense}
        className="fixed bottom-6 right-6 z-40 sm:hidden w-14 h-14 bg-gray-900 text-white rounded-full flex items-center justify-center shadow-lg hover:bg-gray-800 active:scale-95 transition-all duration-200 border border-gray-800"
        title="Add Expense"
      >
